  ...
  process: [
    {
      ...
      body: "We start by getting to know you — your lifestyle, aspirations, functional needs, and the story you want your space to tell.",
    },
    {
      title: "Site Analysis",
      body: "We study your plot thoroughly — orientation, topography, access, natural light, and prevailing winds — so design works with the site, not against it.",
    },
    {
      title: "Concept Design",
      body: "Multiple distinct directions for you to review and choose from — creative exploration and open dialogue at the heart of every concept.",
    },
    {
      title: "Design Development & 3D",
      body: "Photorealistic renders and immersive walkthroughs so you genuinely experience your future space long before construction begins.",
    },
  ],
  faq: [
    {
      q: "Can changes be made after the design is finalised?",
      a: "Minor modifications can usually be accommodated without significant delays. Major structural changes may require revised drawings and extended timelines — discuss as early as possible.",
    },
    {
      q: "How long does the architectural design process typically take?",
      a: "Standard residential projects: 4–8 weeks from brief to approval-ready drawings. Larger residential or commercial: 10–16 weeks or more. We provide a clear schedule at the outset.",
    },
    {
      q: "Do you provide interior design services as well?",
      a: "Yes. We offer fully integrated interior design alongside architecture — ensuring a seamless aesthetic from facade through to every interior space.",
    },
    {
      q: "What should I prepare before our first consultation?",
      a: "Plot dimensions and survey documents, a rough budget range, inspiration images, timeline expectations, and a list of specific requirements.",
    },
  ],
