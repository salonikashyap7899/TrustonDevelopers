...
function Index() {
  const { data: hero } = useSingleRecord<HeroSection>("hero_sections", "page_key", "home");
...
function PhilosophySection() {
  const content = usePageContent("home.philosophy", {
    ...
    body_secondary:
      "Our commitment to quality and transparency ensures that every square foot you own is a testament to enduring luxury — built to outlast trends and appreciate with time.",
  });
...
function Marquee() {
  ...
  return (
    <div
      className="border-y border-white/5 py-8 overflow-hidden relative"
...
function EnhancedStatsBar() {
  ...
  return (
    <section
      className="border-y border-white/5 px-6 relative overflow-hidden"
      style={{ background: "#04090f" }}
    >
